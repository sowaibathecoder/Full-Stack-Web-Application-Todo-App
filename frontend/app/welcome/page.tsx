        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-10 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <Link
                href="/signup"
                className="px-8 py-4 bg-white text-indigo-600 font-semibold rounded-lg shadow-md border border-indigo-200 hover:bg-indigo-50 transition duration-300 text-center"
              >
                Create Account
              </Link>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Organize and prioritize your tasks efficiently</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">Smart Features</h3>
                  <p className="text-gray-600">Recurring tasks, due dates, and priority levels</p>
                </div>
              </div>
            </div>
          </div>
